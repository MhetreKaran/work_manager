...
const handleAddTask = async (event) => {
  ...
  return (
    <div className="grid grid-cols-12 justify-center m-4">
      <div className="border-white col-span-6 col-start-4 px-5 shadow-sm">
        ...
        <form onSubmit={handleAddTask}>
          ...
          <div class="mb-4">
            ...
            <div className="flex justify-center mt-4">
              ...
              <button class="bg-red-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-blue-500 rounded ms-3">
                Clear
              </button>
            </div>
          </div>
